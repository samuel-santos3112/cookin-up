  ...
  <header class="banner">
    <div class="apresentacao">
      ...
      <p class="cabecalho-lg frase-cabecalho">
        <span class="texto-verde">Um banquete de idéias para</span> despertar o chef que há em você!
      </p>

      <p class="subtitulo-lg">
        Explore novas receitas todos os dias com os ingredientes estão ao seu alcance!
      </p>
    </div>
